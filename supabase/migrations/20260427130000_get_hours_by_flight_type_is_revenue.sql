-- Include flight_types.is_revenue so reports can show revenue vs non-revenue hours.
...
BEGIN
  ...
  SELECT
    ...
    COALESCE(ft.is_revenue, true) AS is_revenue,
  ...
  GROUP BY ft.id, ft.name, ft.instruction_type, ft.is_revenue
