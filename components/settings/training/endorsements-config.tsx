...
export function EndorsementsConfig() {
  ...
  const filteredEndorsements = useMemo(() => {
    ...
    if (!term) return endorsements
    return endorsements.filter((endorsement) => {
      return (
        endorsement.name.toLowerCase().includes(term) ||
        (endorsement.description || "").toLowerCase().includes(term)
      )
    })
  ...
  return (
    <div className="space-y-6 max-w-6xl">
      ...
      <p className="text-sm text-slate-600">
        Configure pilot certifications and endorsements such as complex aircraft, high-performance, tailwheel, and
        aerobatics.
      </p>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <DialogDescription className="mt-0.5 text-sm text-slate-500">
                      Create a new certification. Required fields are marked with{" "}
                      ...
                      <div className="flex items-start gap-3 rounded-xl border border-slate-200 bg-slate-50/60 p-3">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-[11px] text-slate-600 mt-1 leading-snug">
                            Whether this certification is available for selection.
                          </p>
                        </div>
                      </div>
                    </div>
      ...
      {filteredEndorsements.length === 0 ? (
        <div className="text-center py-16 bg-slate-50 rounded-xl border border-dashed border-slate-300">
          ...
          <p className="text-slate-900 font-semibold mb-2">
            {searchTerm ? "No matching certifications" : "No certifications configured"}
          </p>
                  ...
                  <TableCell className="font-medium text-slate-900">
                    <div>
                      ...
                      {endorsement.description ? (
                        <div className="text-xs text-slate-500 mt-0.5">{endorsement.description}</div>
                      ) : null}
                    </div>
                  </TableCell>
                  <TableCell>
            ...
            <DialogHeader className="px-6 pt-[calc(1.5rem+env(safe-area-inset-top))] pb-4 text-left sm:pt-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <DialogDescription className="mt-0.5 text-sm text-slate-500">
                    Update certification details. Required fields are marked with{" "}
                    <span className="text-destructive">*</span>.
                  </DialogDescription>
                </div>
              </div>
